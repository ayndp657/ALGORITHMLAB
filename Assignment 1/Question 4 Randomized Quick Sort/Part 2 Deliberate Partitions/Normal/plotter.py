...
axis[0].plot(comp_1_50000, 'o-', label='1/50000')
axis[0].plot(comp_1_10000, 'o-', label='1/10000')
axis[0].plot(comp_1_5000, 'o-', label='1/5000')
axis[0].plot(comp_1_1000, 'o-', label='1/1000')
axis[0].plot(comp_normal, 'o-', label='Randomized')
axis[0].legend()
axis[0].set_ylabel('comparision')

axis[1].plot(time_1_50000, 'o-', label='1/50000')
axis[1].plot(time_1_10000, 'o-', label='1/10000')
axis[1].plot(time_1_5000, 'o-', label='1/5000')
axis[1].plot(time_1_1000, 'o-', label='1/1000')
axis[1].plot(time_normal, 'o-', label = 'Randomized')
axis[1].legend()
