...
const u_long num_vertex = 4847571; //vertex numbering goes from 0 to 4847570
const u_long num_edges = 68993773; //umber of lines in dataset, will be inly used to display progress bar
