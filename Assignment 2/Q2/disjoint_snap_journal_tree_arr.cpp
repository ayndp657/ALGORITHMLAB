...
const u_long numVertices = 4847571; //vertex numbering goes from 0 to 4847570
const u_long numEdges = 68993773;   //umber of lines in dataset, will be inly used to display progress bar'

const char filePath[] = "Dataset/SNAP/3_LiveJournal/soc-LiveJournal1.txt";
